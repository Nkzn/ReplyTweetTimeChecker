package net.nkzn.appengine.app.twrtt.service;

import java.util.List;

import org.slim3.datastore.Datastore;
import net.nkzn.appengine.app.twrtt.model.Slim3Model;
import net.nkzn.appengine.app.twrtt.meta.Slim3ModelMeta;
